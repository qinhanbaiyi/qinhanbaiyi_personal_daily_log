...
noremap <LEADER>sv :e $HOME/.config/nvim/init.vim<CR>
noremap <LEADER>ev :e .nvimrc<CR>
...
" ===
" I don't kown the reason of using below.
cnoremap <C-a> <Home>
cnoremap <C-e> <End>
cnoremap <C-p> <Up>
cnoremap <C-n> <Down>
...
noremap psh <C-w>t<C-w>K
" Place the two screens side by side
noremap psv <C-w>t<C-w>H
